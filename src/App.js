...
class App extends Component {
  ...
  messages = {
    ...
    accept_incorrect: 'Nie potwierdzony regulamin.'
  }
    ...
    return (
      <div className="App" >
        <form onSubmit={this.handleSubmit} noValidate>
          ...
          <input type="password" id="pasword" name="pass" value={this.state.pass} onChange={this.handleChange} />
            {this.state.errors.pass && <span>{this.messages.password_incorrect}</span>}
          </label>

          <label htmlFor="accept">
            <input id="accept" type="checkbox" name="accept" checked={this.state.accept} onChange={this.handleChange} /> Akceptuję regulmin.
          </label>
